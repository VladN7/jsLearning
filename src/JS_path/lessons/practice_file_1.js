...
5) (mine) Check that the user entered the correct data
...
7) Create a function showMyDB, which will check the private property. If it is false -
displays the main program object in the console
...
function declarePrompts() {
  return {
    moviePrompt: prompt('Write one of the last films you watched', ''),
    ratingPrompt: prompt('How would you rate it?', '')
  };
}
